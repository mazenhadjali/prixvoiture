        ...
        <React.Fragment>
            <div className="container mx-auto p-4">
                ...
                <div className="container bg-gray-100 border-2 rounded-lg p-2">
                    ...
                    <form className="flex justify-around p-2 m-2" onSubmit={(event) => { event.preventDefault(); handleSubmit(null, fiche?._id, event.currentTarget.nom.value, event.currentTarget.valeur.value) }}>
                        ...
                        <div className="md:flex md:items-center">
                            ...
                            <div className="md:w-2/3">
                                <input required type="number" id="valeur" placeholder="Valeur en dt" name="valeur" className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-main leading-tight focus:outline-none focus:bg-white focus:border-purple-500" />
                            </div>
                        </div>
                            ...
                            <div className=" grid gap-4 gap-y-2 text-sm grid-cols-3">
                                <div>
                                    <div className="flex items-center justify-start">
                                        ...
                                        <div className="md:w-2/3">
                                            <label className="block text-black font-bold mb-1 md:mb-0 pr-4" htmlFor="valeur">
                                                {parent?.nom}
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div className="bg-gray-100 border-2 rounded-lg p-1 col-span-2">
                                    <h1 className="text-xl text-main font-bold">Ajouter Sous-Option:</h1>
