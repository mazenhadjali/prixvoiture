            ...
            <section className="body-bg h-full dark:bg-gray-900 flex justify-center">
                <div className="grid py-8 px-4 mx-auto max-w-screen-xl lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 flex justify-center items-center">
                    <div className="place-self-center mr-auto lg:col-span-7">
                        ...
                        <a href="#" className=" mx-3 inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg border border-white hover:bg-white-100 focus:ring-4 focus:ring-white-100">
                            Estimez Votre Voiture
                        </a>
                        <Link to={LOGIN} className=" mx-3 inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white hover:text-main rounded-lg border border-main hover:bg-gray-100 focus:ring-4 focus:ring-main">
                            Se Connecter
                        </Link>
                    </div>
